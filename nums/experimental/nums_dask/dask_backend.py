...
class DaskBackend(Backend):
    ...
    def init_devices(self):
        ...
        for node_id in range(num_nodes):
            ...
            for worker_id, worker_addr in enumerate(workers):
                ...
                did = Device(node_id, node_addr, "cpu", worker_id)
    ...
    def put(self, value: Any, device: Device):
        ...
        node_addr = device.node_addr
        worker_addrs = self._node_to_worker[node_addr]["workers"]
        worker_addr = worker_addrs[device.device]
    ...
    def call(self, name: str, args, kwargs, device: Device, options: Dict):
        return self._call(
            ...
            kwargs,
            options,
            workers=self._node_to_worker[device.node_addr]["workers"][device.device],
        )
